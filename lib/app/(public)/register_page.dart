            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  LogoImage(),
                  SizedBox(height: 15),
                  TextFieldPrimary(textFieldName: "nome"),
                  SizedBox(height: 15),
                  TextFieldPrimary(textFieldName: "sobrenome"),
                  SizedBox(height: 15),
                  TextFieldPrimary(textFieldName: "e-mail"),
                  SizedBox(height: 15),
                  TextFieldPrimary(textFieldName: "telefone"),
                  SizedBox(height: 15),
                  TextFieldPrimary(textFieldName: "senha"),
                  SizedBox(height: 15),
                  TextFieldPrimary(textFieldName: "confirmar senha"),
                  SizedBox(height: 5),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
